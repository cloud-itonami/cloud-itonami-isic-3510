# Operator Quickstart — Community Grid Transmission and Distribution Operations

Shortest path from clone to a verified local dry-run for **ISIC 3510** (`cloud-itonami-isic-3510`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3510.git
cd cloud-itonami-isic-3510
```
...
- Blueprint governor key: `grid-transmission-governor`
- Likely source path: `src/**/grid-transmission-governor.cljc`
